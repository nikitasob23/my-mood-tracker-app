...
import com.niksob.app.view.main.activity.viewmodel.startdataloader.MainActivityWithStartDataLoader
...
open class LoggableAuthLoaderMainActivity : MainActivityWithStartDataLoader() {
    @Inject
    lateinit var logger: AppDebugLogger

    private val tag get() = LoggableAuthLoaderMainActivity::class.simpleName!!
